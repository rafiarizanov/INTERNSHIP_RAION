...
class _WLupaPasswordState extends State<WLupaPassword> {
  ...
  Future<void> _handleResetPassword() async {
    ...
    if (error == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Kode OTP pemulihan telah dikirim ke email Anda.'),
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => WOtpPassword(email: email)),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Masukkan email yang terdaftar. Kami akan mengirimkan kode 6 digit untuk mengatur ulang kata sandi Anda.',
